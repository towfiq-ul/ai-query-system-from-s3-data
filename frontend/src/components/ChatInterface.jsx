      ...
      <div style={styles.messages}>
        {messages.length === 0 && (
          <div style={styles.empty}>
            ...
            <p style={styles.emptyHint}>Supports PDF, TXT, CSV, and JSON files</p>
          </div>
        )}
...
const styles = {
  ...
  select:      { background: "#1a1f2e", color: "#e2e8f0", border: "1px solid #2d3748",
                  borderRadius: 6, padding: "4px 8px", fontSize: 13 },
  ghostBtn:    { background: "transparent", color: "#a0aec0", border: "1px solid #2d3748",
                  borderRadius: 6, padding: "5px 12px", fontSize: 13, cursor: "pointer" },
  indexPanel:  { background: "#1a1f2e", borderBottom: "1px solid #2d3748",
                  padding: "16px 24px", flexShrink: 0 },
  indexTitle:  { margin: "0 0 12px", fontSize: 15, fontWeight: 600 },
  indexRow:    { display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" },
  input:       { background: "#0f1117", border: "1px solid #2d3748", color: "#e2e8f0",
  ...
  primaryBtn:  { background: "#2d6cdf", color: "#fff", border: "none", borderRadius: 6,
  ...
  typing:      { background: "#1a1f2e", borderRadius: 12, padding: "14px 18px",
                  display: "flex", gap: 5, alignItems: "center" },
  inputRow:    { display: "flex", gap: 10, padding: "16px 24px", borderTop: "1px solid #1e2130",
                  flexShrink: 0 },
  textarea:    { flex: 1, background: "#1a1f2e", border: "1px solid #2d3748", color: "#e2e8f0",
                  borderRadius: 10, padding: "10px 14px", fontSize: 15, resize: "none",
                  lineHeight: 1.5, outline: "none" },
  sendBtn:     { width: 42, height: 42, background: "#2d6cdf", color: "#fff", border: "none",
